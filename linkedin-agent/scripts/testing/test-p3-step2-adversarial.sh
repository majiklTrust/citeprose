...
run_mjs "Groups 1+2+6: Hostile network" "$SCRIPT_DIR/test-p3-step2-adversarial/hostile-network.mjs"
run_mjs "Groups 3+4+5: Hostile input" "$SCRIPT_DIR/test-p3-step2-adversarial/hostile-input.mjs"
