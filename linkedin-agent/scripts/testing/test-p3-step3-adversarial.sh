...
run_mjs "Groups 1+2+3: Hostile tokens" "$SCRIPT_DIR/test-p3-step3-adversarial/hostile-tokens.mjs"
run_mjs "Groups 4+5+6: Hostile middleware" "$SCRIPT_DIR/test-p3-step3-adversarial/hostile-middleware.mjs"
