#!/bin/bash
# ═══════════════════════════════════════════════════════════════
# Phase 3 Step 1 — Registry Architecture & Design Test Suite
# ═══════════════════════════════════════════════════════════════
_FULL_LOG=$(mktemp)
...
echo ""
echo "═══════════════════════════════════════════════════════════"
echo "  Phase 3 Step 1 — Registry Architecture & Design"
echo "═══════════════════════════════════════════════════════════"
echo ""
...
run_mjs "Groups 1+2: Registry module design" "$SCRIPT_DIR/test-p3-step1-design/registry-module-design.mjs"
run_mjs "Groups 3+4: Registry state design" "$SCRIPT_DIR/test-p3-step1-design/registry-state-design.mjs"
