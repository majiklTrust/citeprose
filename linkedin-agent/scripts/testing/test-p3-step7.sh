#!/bin/bash
# ═══════════════════════════════════════════════════════════════
# Phase 3 Step 7 — Dashboard Login Wall Test Suite
# ═══════════════════════════════════════════════════════════════
...
echo ""
echo "═══════════════════════════════════════════════════════════"
echo "  Phase 3 Step 7 — Dashboard Login Wall Test Suite"
echo "═══════════════════════════════════════════════════════════"
echo ""
...
SCRIPT_DIR="scripts/testing/test-p3-step7"
...
run_group "status-and-devmode.mjs" "Groups 1-2 (status auth fields + dev mode)" 13
run_group "dashboard-auth.mjs" "Groups 3-4 (dashboard auth UI + 401 handling)" 10

echo ""
echo "  ═══════════════════════════════════════"
echo "  Phase 3 Step 7 — Dashboard Login Wall:"
