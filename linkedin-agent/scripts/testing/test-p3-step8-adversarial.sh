#!/bin/bash
# ═══════════════════════════════════════════════════════════════
# Phase 3 Step 8 — Backward Compatibility ADVERSARIAL Test Suite
# ═══════════════════════════════════════════════════════════════
...
echo ""
echo "═══════════════════════════════════════════════════════════"
echo "  Phase 3 Step 8 — Backward Compat ADVERSARIAL Test Suite"
echo "═══════════════════════════════════════════════════════════"
echo ""
...
SCRIPT_DIR="scripts/testing/test-p3-step8-adversarial"
...
run_group "oauth-interference.mjs" "Groups 1-2 (OAuth cross-contamination + error handler)" 8

echo ""
echo "  ═══════════════════════════════════════"
echo "  Phase 3 Step 8 — Backward Compat ADVERSARIAL:"
