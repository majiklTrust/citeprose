...
console.log('  File: test-p3-step2-design/provider-module-design.mjs');
...
test('3.2.1.1-D', ' Auth0.js must have a default export (the provider object)', () => {
...
test('3.2.1.2-D', ' The provider object must implement all 7 interface fields', () => {
...
test('3.2.1.3-D', ' The provider object must implement all 7 interface methods', () => {
...
test('3.2.1.4-D', ' Auth0.js must not import from the registry (index.js)', () => {
...
test('3.2.1.5-D', ' Auth0.js must not import jose directly', () => {
...
test('3.2.1.6-D', ' Auth0.js must not import from middleware.js', () => {
...
test('3.2.1.7-D', ' Auth0.js must not import from src/routes/ or src/services/', () => {
...
test('3.2.1.8-D', ' Provider.name must be a string constant, not computed', () => {
...
test('3.2.1.9-D', ' Provider.type must be "oidc"', () => {
...
test('3.2.1.10-D', ' Provider.priority must be a positive integer', () => {
...
test('3.2.2.1-D', ' Test helpers must be prefixed with underscore', () => {
...
test('3.2.2.2-D', ' _getConfig exists', () => {
...
test('3.2.2.3-D', ' _getConfig returns different objects', () => {
...
test('3.2.2.4-D', ' _generateState and _validateState must exist for testing', () => {
...
test('3.2.2.5-D', ' BLOCKED_DOMAIN_PATTERNS or equivalent must exist in source', () => {
...
test('3.2.2.6-D', ' STATE_TTL_MS or equivalent must exist in source', () => {
...
test('3.2.2.7-D', ' DISCOVERY_TTL_MS or equivalent must exist in source', () => {
...
test('3.2.2.8-D', ' Auth0 provider must have a shutdown method', () => {
